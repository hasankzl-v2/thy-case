...
/*
* handle exceptions, return different ErrorResponse for each exception
* */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleLocationAlreadyExistsException(LocationAlreadyExistsException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(ErrorCodeEnum.LOCATION_ALREADY_EXIST, "Location with given location code is already exists."));
    }

    @ExceptionHandler(LocationNotFoundException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<ErrorResponse> handleLocationNotFoundException(LocationNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(ErrorCodeEnum.LOCATION_NOT_FOUND, "Location not found with given id. " + ex.getId()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleTransportationAlreadyExistsException(TransportationAlreadyExistsException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(ErrorCodeEnum.TRANSPORTATION_ALREADY_EXIST, "Transportation with given data is already exists."));
    ...
    public ResponseEntity<ErrorResponse> handleTransportationNotFoundException(TransportationNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(ErrorCodeEnum.TRANSPORTATION_NOT_FOUND, "Transportation not found with given id. " + ex.getId()));

    }

    @ExceptionHandler(GeneralException.class)
    public ResponseEntity<ErrorResponse> handleGeneralException(GeneralException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(ErrorCodeEnum.GENERAL_ERROR, ex.getMessage()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleTransportationOperationDaysNotValidException(Exception ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(ErrorCodeEnum.TRANSPORTATION_OPERATION_DAYS_NOT_VALID, "Transportation operation days not valid."));
    }
